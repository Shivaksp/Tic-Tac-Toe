    ...
    wins.forEach(e => {
        if ((boxtexts[e[0]].innerText === boxtexts[e[1]].innerText) && (boxtexts[e[0]].innerText === boxtexts[e[2]].innerText) && (boxtexts[e[0]].innerText !== "")) {
            ...
            if(screenWidth >= 800 ){
                ...
                document.querySelector(".line").style.transform = `translate(${e[3]*2-2}vw, ${e[4]*2}vw) rotate(${e[5]}deg)`
...
Array.from(boxes).forEach(element => {
    ...
    element.addEventListener('click', () => {
        ...
        else if (boxtext.innerText === '' && !isgameover) {
